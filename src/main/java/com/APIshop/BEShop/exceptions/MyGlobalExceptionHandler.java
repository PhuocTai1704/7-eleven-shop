package com.APIshop.BEShop.exceptions;
...
import com.APIshop.BEShop.payloads.APIResponse;
...
public class MyGlobalExceptionHandler {
    ...
    public ResponseEntity<APIResponse> handleAccessDenied(AccessDeniedException e) {
        APIResponse res = new APIResponse("Bạn không có quyền truy cập vào tài nguyên này", false);
        return new ResponseEntity<>(res, HttpStatus.FORBIDDEN);
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<APIResponse> handleAllExceptions(Exception e) {
        APIResponse res = new APIResponse("Server đã xảy ra lỗi: " + e.getMessage(),
                false);
